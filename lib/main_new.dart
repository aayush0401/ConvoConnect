...
void main() async {
  ...
  try {
    ...
    // This uses your npm Firebase config: zoom-clone-83125
    await FirebaseService.initializeFirebase();
    print('🚀 Zoom Clone: Firebase initialized with npm config');
    print('📱 Project: ${FirebaseService.app.options.projectId}');
  } catch (e) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        appBarTheme: const AppBarTheme(
          backgroundColor: Color(0xFF424242), // Greyish black
